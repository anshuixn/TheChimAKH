      ...
      <header className={styles.pageHeader}>
        <div className={styles.container}>
          <div className={styles.badgeRow}>
            ...
            <span className="visual-badge">ESTABLISHED HERITAGE</span>
          </div>
        ...
        <div className={styles.container}>
          <div className={styles.storyGrid}>
            ...
            <div className="ambient-glow-card">
              ...
              <p className={styles.storyText}>
                Our central operational headquarters and production kiln complex operate continuous high-draft coal-fired firing loops to supply high-strength structural bricks.
              </p>
              <p className={styles.storyText}>
                Our facility incorporates weather-protected drying arrays, automated raw preparation pug mills, and multi-chamber continuous kiln pathways for seasonal volume outputs.
              </p>
            </div>
      ...
      <section className={`${styles.valuesSection} scroll-reveal`} aria-label="Core values">
        <div className={styles.container}>
          ...
          <div className={styles.valuesGrid}>
            <div className={`${styles.valueCard} ambient-glow-card`}>
